 ...
 */
export declare const RULE_SSM_PRINCIPALS_ARE_REGIONAL: string;
/**
 ...
 */
export declare const RULE_S3_WEBSITE_REGIONAL_SUBDOMAIN: string;
/**
 ...
 * rule was introduced.
 */
export declare const AWS_REGIONS_AND_RULES: string[];
/**
 ...
 */
export declare function before(region: string, ruleOrRegion: string): boolean;
/**
 * Return all regions before a given rule was introduced (or region)
 */
export declare function regionsBefore(ruleOrRegion: string): string[];
 ...
 */
export declare function generateRegionMap(cb: (region: string) => string): Record<string, string>;
